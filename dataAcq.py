...
with open('random_catalog_sample+1000.csv','rb') as csvfile: #rand cat
...
size = 1.0
for i in range(100):
    dir = 'RandSample/FITS/'+'index-'+str(i) #rand cat
    ...
    if len(fileList)==0:
        ...
        position = open(dir+'/stellar_coordinates.txt','wb')
        ...
        imgfmt = 'fits' #actually stores as a png, badly named api property
